...
│   └── com/example/captcha/               # 滑块验证码组件 (新增)
│       ├── SliderCaptcha.java             # 基础滑块验证码
│       ├── AdvancedSliderCaptcha.java     # 高级滑块验证码
│       └── CaptchaUtils.java              # 验证码工具类
├── target/                                 # 构建输出目录
├── build-mac-installer.sh                 # PKG 安装包构建脚本
├── build-dmg.sh                          # DMG 磁盘镜像构建脚本
├── demo-captcha.sh                       # 验证码演示脚本 (新增)
├── pom.xml                               # Maven 配置文件
├── README.md                             # 项目说明文档
└── CAPTCHA_README.md                     # 验证码详细文档 (新增)
```
