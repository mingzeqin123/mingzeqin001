...
一个功能丰富的微信小程序游戏平台，包含多个精彩的游戏和实用工具。

## 🎮 功能特色

### 推箱子AI求解器 ⭐ 新功能
- **智能图像识别**：上传推箱子游戏截图，AI自动分析游戏布局
- **最优解算法**：使用A*搜索算法找到最少步数的解决方案
- **可视化展示**：详细的步骤演示和操作指导
- **测试关卡**：内置多个难度递增的测试关卡
- **实时渲染**：Canvas 2D渲染游戏状态
...
│       └── watermark.wxss # 页面样式
├── docs/                 # 文档目录
│   └── sokoban-solver-guide.md # 推箱子求解器使用指南
├── images/               # 图片资源
├── sounds/               # 音效资源
